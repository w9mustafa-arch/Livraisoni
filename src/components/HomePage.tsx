...
className="absolute left-0 right-0 -bottom-1 h-[3px] bg-primary rounded-full"
/>
...
<button className="bg-primary text-primary-foreground px-6 py-2 rounded-full font-bold shadow hover:scale-105 transition">
Join
</button>
